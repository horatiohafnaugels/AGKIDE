...
void configuration_open_files(struct GeanyProject *project);

void configuration_reload_default_session(void);

void configuration_save_default_session(void);

void configuration_load_project_files(GKeyFile *config, struct GeanyProject *project);

void configuration_load_session_files(GKeyFile *config, struct GeanyProject *project);

void configuration_load_recent_files(GKeyFile *config);

void configuration_save_session_files(GKeyFile *config, struct GeanyProject *project);

void configuration_save_project_files(GKeyFile *config, struct GeanyProject *project);
