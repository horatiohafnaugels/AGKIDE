...
static void prefs_init_dialog(void)
{
	...
	widget = ui_lookup_widget(ui_widgets.prefs_dialog, "remember_open_projects");
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(widget), prefs.remember_projects);
	...
	widget = ui_lookup_widget(ui_widgets.prefs_dialog, "auto_hide_message_bar");
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(widget), interface_prefs.auto_hide_message_bar);
	...
	widget = ui_lookup_widget(ui_widgets.prefs_dialog, "check_highlight_selection");
	gtk_toggle_button_set_active(GTK_TOGGLE_BUTTON(widget), editor_prefs.highlight_selection);
...
on_prefs_dialog_response(GtkDialog *dialog, gint response, gpointer user_data)
{
	if (response == GTK_RESPONSE_OK || response == GTK_RESPONSE_APPLY)
	{
		...
		widget = ui_lookup_widget(main_widgets.window, "vpaned2");
		...
		widget = ui_lookup_widget(ui_widgets.prefs_dialog, "remember_open_projects");
		prefs.remember_projects = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget));
		...
		widget = ui_lookup_widget(ui_widgets.prefs_dialog, "auto_hide_message_bar");
		interface_prefs.auto_hide_message_bar = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget));
		...
		widget = ui_lookup_widget(ui_widgets.prefs_dialog, "check_highlight_selection");
		editor_prefs.highlight_selection = gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(widget));
