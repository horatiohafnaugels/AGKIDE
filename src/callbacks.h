...
G_MODULE_EXPORT void
on_trial_image_event_button_press_event(GtkWidget *widget, 
										GdkEvent *event, 
										gpointer user_data);
...
G_MODULE_EXPORT void
on_what_notifications_event_button_press_event(GtkWidget *widget, 
										GdkEvent *event, 
										gpointer user_data);
G_MODULE_EXPORT void on_show_what_notifications_dialog();
...
G_MODULE_EXPORT void
on_help_menu_item_tgc_activate(GtkMenuItem *item, gpointer user_data);
...
G_MODULE_EXPORT void
on_toolbutton_broadcast_clicked		  (GtkAction	   *action,
										gpointer		 user_data);

G_MODULE_EXPORT void
on_toolbutton_debug_clicked			  (GtkAction	   *action,
										gpointer		 user_data);
