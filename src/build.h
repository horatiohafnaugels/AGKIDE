...
typedef enum
{
	...
	//GEANY_GBO_RUN,			/* *< AGK run button */
	//GEANY_GBO_BROADCAST,	/* *< AGK broadcast button */
	//GEANY_GBO_RUN_BROADCAST,/* *< AGK run and broadcast button */
...
int build_compile_project(gboolean run);
