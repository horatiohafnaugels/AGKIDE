...
static void init_default_kb(void)
{
	...
	add_kb(group, GEANY_KEYS_FILE_NEW, NULL,
		GDK_n, GDK_PRIMARY_MODIFIER, "menu_new", _("New File"), "menu_new1");
	add_kb(group, GEANY_KEYS_FILE_OPEN, NULL,
		GDK_o, GDK_PRIMARY_MODIFIER, "menu_open", _("Open"), "menu_open1");
	//add_kb(group, GEANY_KEYS_FILE_OPENSELECTED, NULL,
	//	GDK_o, GDK_SHIFT_MASK | GDK_PRIMARY_MODIFIER, "menu_open_selected",
	//	_("Open selected file"), "menu_open_selected_file1");
	add_kb(group, GEANY_KEYS_FILE_SAVE, NULL,
		GDK_s, GDK_PRIMARY_MODIFIER, "menu_save", _("Save"), "menu_save1");
	add_kb(group, GEANY_KEYS_FILE_SAVEAS, NULL,
		0, 0, "menu_saveas", _("Save as"), "menu_save_as1");
	add_kb(group, GEANY_KEYS_FILE_SAVEALL, NULL,
		GDK_s, GDK_SHIFT_MASK | GDK_PRIMARY_MODIFIER, "menu_saveall", _("Save all"),
		"menu_save_all1");
	add_kb(group, GEANY_KEYS_FILE_PRINT, NULL,
		GDK_p, GDK_PRIMARY_MODIFIER, "menu_print", _("Print"), "print1");
	add_kb(group, GEANY_KEYS_FILE_CLOSE, NULL,
		GDK_w, GDK_PRIMARY_MODIFIER, "menu_close", _("Close"), "menu_close1");
	add_kb(group, GEANY_KEYS_FILE_CLOSEALL, NULL,
		GDK_w, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "menu_closeall", _("Close all"),
		"menu_close_all1");
	add_kb(group, GEANY_KEYS_FILE_RELOAD, NULL,
		GDK_r, GDK_PRIMARY_MODIFIER, "menu_reloadfile", _("Reload file"), "menu_reload1");
	...
	add_kb(group, GEANY_KEYS_FILE_QUIT, NULL,
		GDK_q, GDK_PRIMARY_MODIFIER, "menu_quit", _("Quit"), "menu_quit1");
	...
	add_kb(group, GEANY_KEYS_EDITOR_UNDO, NULL,
		GDK_z, GDK_PRIMARY_MODIFIER, "menu_undo", _("Undo"), "menu_undo2");
	add_kb(group, GEANY_KEYS_EDITOR_REDO, NULL,
		GDK_y, GDK_PRIMARY_MODIFIER, "menu_redo", _("Redo"), "menu_redo2");
	add_kb(group, GEANY_KEYS_EDITOR_DUPLICATELINE, NULL,
		GDK_d, GDK_PRIMARY_MODIFIER, "edit_duplicateline", _("_Duplicate Line or Selection"),
		"duplicate_line_or_selection1");
	add_kb(group, GEANY_KEYS_EDITOR_DELETELINE, NULL,
		GDK_k, GDK_PRIMARY_MODIFIER, "edit_deleteline", _("_Delete Current Line(s)"),
		"delete_current_lines1");
	add_kb(group, GEANY_KEYS_EDITOR_DELETELINETOEND, NULL,
		GDK_Delete, GDK_SHIFT_MASK | GDK_PRIMARY_MODIFIER, "edit_deletelinetoend",
	...
	add_kb(group, GEANY_KEYS_EDITOR_SCROLLTOLINE, NULL,
		GDK_l, GDK_SHIFT_MASK | GDK_PRIMARY_MODIFIER, "edit_scrolltoline", _("Scroll to current line"), NULL);
	...
	add_kb(group, GEANY_KEYS_EDITOR_AUTOCOMPLETE, NULL,
		GDK_space, GDK_PRIMARY_MODIFIER, "edit_autocomplete", _("Complete word"), NULL);
	add_kb(group, GEANY_KEYS_EDITOR_CALLTIP, NULL,
		GDK_space, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "edit_calltip", _("Show calltip"), NULL);
	add_kb(group, GEANY_KEYS_EDITOR_MACROLIST, NULL,
		GDK_Return, GDK_PRIMARY_MODIFIER, "edit_macrolist", _("Show macro list"), NULL);
	...
	add_kb(group, GEANY_KEYS_CLIPBOARD_CUT, NULL,
		GDK_x, GDK_PRIMARY_MODIFIER, "menu_cut", _("Cut"), "menu_cut1");
	add_kb(group, GEANY_KEYS_CLIPBOARD_COPY, NULL,
		GDK_c, GDK_PRIMARY_MODIFIER, "menu_copy", _("Copy"), "menu_copy1");
	add_kb(group, GEANY_KEYS_CLIPBOARD_PASTE, NULL,
		GDK_v, GDK_PRIMARY_MODIFIER, "menu_paste", _("Paste"), "menu_paste1");
	add_kb(group, GEANY_KEYS_CLIPBOARD_COPYLINE, NULL,
		GDK_c, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "edit_copyline", _("_Copy Current Line(s)"),
		"copy_current_lines1");
	add_kb(group, GEANY_KEYS_CLIPBOARD_CUTLINE, NULL,
		GDK_x, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "edit_cutline", _("_Cut Current Line(s)"),
		"cut_current_lines1");

	group = keybindings_get_core_group(GEANY_KEY_GROUP_SELECT);

	add_kb(group, GEANY_KEYS_SELECT_ALL, NULL,
		GDK_a, GDK_PRIMARY_MODIFIER, "menu_selectall", _("Select All"), "menu_select_all1");
	...
	add_kb(group, GEANY_KEYS_FORMAT_TOGGLECASE, NULL,
		GDK_u, GDK_PRIMARY_MODIFIER | GDK_MOD1_MASK, "edit_togglecase",
		_("T_oggle Case of Selection"), "menu_toggle_case2");
	add_kb(group, GEANY_KEYS_FORMAT_COMMENTLINETOGGLE, NULL,
		GDK_e, GDK_PRIMARY_MODIFIER, "edit_commentlinetoggle", _("Toggle line commentation"),
	...
	add_kb(group, GEANY_KEYS_FORMAT_INCREASEINDENT, NULL,
		GDK_i, GDK_PRIMARY_MODIFIER, "edit_increaseindent", _("Increase indent"),
		"menu_increase_indent1");
	add_kb(group, GEANY_KEYS_FORMAT_DECREASEINDENT, NULL,
		GDK_u, GDK_PRIMARY_MODIFIER, "edit_decreaseindent", _("Decrease indent"),
	...
	add_kb(group, GEANY_KEYS_FORMAT_SENDTOCMD1, NULL,
		GDK_1, GDK_PRIMARY_MODIFIER, "edit_sendtocmd1", _("Send to Custom Command 1"), NULL);
	add_kb(group, GEANY_KEYS_FORMAT_SENDTOCMD2, NULL,
		GDK_2, GDK_PRIMARY_MODIFIER, "edit_sendtocmd2", _("Send to Custom Command 2"), NULL);
	add_kb(group, GEANY_KEYS_FORMAT_SENDTOCMD3, NULL,
		GDK_3, GDK_PRIMARY_MODIFIER, "edit_sendtocmd3", _("Send to Custom Command 3"), NULL);
	...
	add_kb(group, GEANY_KEYS_FORMAT_REFLOWPARAGRAPH, NULL,
		GDK_j, GDK_PRIMARY_MODIFIER, "format_reflowparagraph", _("_Reflow Lines/Block"),
		"reflow_lines_block1");
	...
	add_kb(group, GEANY_KEYS_SETTINGS_PREFERENCES, cb_func_menu_preferences,
		GDK_p, GDK_PRIMARY_MODIFIER | GDK_MOD1_MASK, "menu_preferences", _("Preferences"),
		"preferences1");
	...
	add_kb(group, GEANY_KEYS_SEARCH_FIND, NULL,
		GDK_f, GDK_PRIMARY_MODIFIER, "menu_find", _("Find"), "find1");
	add_kb(group, GEANY_KEYS_SEARCH_FINDNEXT, NULL,
		GDK_g, GDK_PRIMARY_MODIFIER, "menu_findnext", _("Find Next"), "find_next1");
	add_kb(group, GEANY_KEYS_SEARCH_FINDPREVIOUS, NULL,
		GDK_g, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "menu_findprevious", _("Find Previous"),
		"find_previous1");
	...
	add_kb(group, GEANY_KEYS_SEARCH_REPLACE, NULL,
		GDK_h, GDK_PRIMARY_MODIFIER, "menu_replace", _("Replace"), "replace1");
	add_kb(group, GEANY_KEYS_SEARCH_FINDINFILES, NULL, GDK_f,
		GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "menu_findinfiles", _("Find in Files"),
		"find_in_files1");
	...
	add_kb(group, GEANY_KEYS_SEARCH_FINDUSAGE, NULL,
		GDK_e, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "popup_findusage",
		_("Find Usage"), "find_usage1");
	add_kb(group, GEANY_KEYS_SEARCH_FINDDOCUMENTUSAGE, NULL,
		GDK_d, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "popup_finddocumentusage",
		_("Find Document Usage"), "find_document_usage1");
	add_kb(group, GEANY_KEYS_SEARCH_MARKALL, NULL,
		GDK_m, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "find_markall", _("_Mark All"), "mark_all1");
	...
	add_kb(group, GEANY_KEYS_GOTO_PREVWORDPART, NULL,
		GDK_slash, GDK_PRIMARY_MODIFIER, "edit_prevwordstart", _("Go to Previous Word Part"), NULL);
	add_kb(group, GEANY_KEYS_GOTO_NEXTWORDPART, NULL,
		GDK_backslash, GDK_PRIMARY_MODIFIER, "edit_nextwordstart", _("Go to Next Word Part"), NULL);
	...
	add_kb(group, GEANY_KEYS_VIEW_ZOOMIN, NULL,
		GDK_plus, GDK_PRIMARY_MODIFIER, "menu_zoomin", _("Zoom In"), "menu_zoom_in1");
	add_kb(group, GEANY_KEYS_VIEW_ZOOMOUT, NULL,
		GDK_minus, GDK_PRIMARY_MODIFIER, "menu_zoomout", _("Zoom Out"), "menu_zoom_out1");
	add_kb(group, GEANY_KEYS_VIEW_ZOOMRESET, NULL,
		GDK_0, GDK_PRIMARY_MODIFIER, "normal_size", _("Zoom Reset"), "normal_size1");
	...
	add_kb(group, GEANY_KEYS_FOCUS_SCRIBBLE, NULL,
		0, 0, "switch_scribble", _("Switch to Scribble"), NULL);
	...
	add_kb(group, GEANY_KEYS_NOTEBOOK_SWITCHTABLEFT, cb_func_switch_tableft,
		GDK_Page_Up, GDK_PRIMARY_MODIFIER, "switch_tableft", _("Switch to left document"), NULL);
	add_kb(group, GEANY_KEYS_NOTEBOOK_SWITCHTABRIGHT, cb_func_switch_tabright,
		GDK_Page_Down, GDK_PRIMARY_MODIFIER, "switch_tabright", _("Switch to right document"), NULL);
	add_kb(group, GEANY_KEYS_NOTEBOOK_SWITCHTABLASTUSED, cb_func_switch_tablastused,
		GDK_Tab, GDK_PRIMARY_MODIFIER, "switch_tablastused", _("Switch to last used document"), NULL);
	add_kb(group, GEANY_KEYS_NOTEBOOK_MOVETABLEFT, cb_func_move_tab,
		GDK_Page_Up, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "move_tableft",
		_("Move document left"), NULL);
	add_kb(group, GEANY_KEYS_NOTEBOOK_MOVETABRIGHT, cb_func_move_tab,
		GDK_Page_Down, GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK, "move_tabright",
	...
	add_kb(group, GEANY_KEYS_DOCUMENT_RELOADTAGLIST, NULL,
		GDK_r, GDK_SHIFT_MASK | GDK_PRIMARY_MODIFIER, "reloadtaglist", _("Reload symbol list"), NULL);
	...
	add_kb(group, GEANY_KEYS_BUILD_COMPILE, NULL,
		GDK_F7, 0, "build_compile", _("Compile"), "build_compile1");
	add_kb(group, GEANY_KEYS_BUILD_RUN, NULL,
		GDK_F5, 0, "build_run", _("Run"), "build_run1");
	...
	//	GDK_F9, GDK_SHIFT_MASK | GDK_PRIMARY_MODIFIER, "build_makeowntarget",
...
static gboolean check_vte(GdkModifierType state, guint keyval)
{
	...
	if (state == (GDK_PRIMARY_MODIFIER | GDK_SHIFT_MASK) && (keyval == GDK_c || keyval == GDK_v))
		return TRUE;
...
static gboolean cb_func_build_action2(guint key_id)
{
	...
	if (!gtk_widget_is_sensitive(ui_lookup_widget(main_widgets.window, "menu_build3")))
		return TRUE;
	...
	switch (key_id)
	{
		case GEANY_KEYS_BUILD_COMPILE:
			...
			break;
		//case GEANY_KEYS_BUILD_NEXTERROR:
		//	dialogs_show_msgbox(GTK_MESSAGE_ERROR, "Next Error");
		//	break;
		//case GEANY_KEYS_BUILD_PREVIOUSERROR:
		//	dialogs_show_msgbox(GTK_MESSAGE_ERROR, "Prev Error");
		//	break;
		case GEANY_KEYS_BUILD_RUN:
			build_run_project( -1 );
			break;
		case GEANY_KEYS_BUILD_BROADCAST:
			build_broadcast_project( -1 );
			break;
		case GEANY_KEYS_BUILD_DEBUG:
			build_debug_project( -1 );
			break;
		case GEANY_KEYS_BUILD_OPTIONS:
			//dialogs_show_msgbox(GTK_MESSAGE_ERROR, "Options");
			break;
		default:
			break;
	}
